...
Semantic HTML adds meaning to the code and what the tags represent instead of using tags that appear to not have much surface meaning.
...
the center of the cross axis, By default the cross axis is vertical so this means the flexbox items will be centered vertically.
